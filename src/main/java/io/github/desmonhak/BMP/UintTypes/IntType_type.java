...
/**
 * Tipo de valor numerico que representa
 */
public enum IntType_type {
    /**
     * Valor de tipo uint8_t = 8bits
     */
    uint8_t,

    /**
     * Valor de tipo uint16_t = 16bits
     */
    uint16_t,

    /**
     * Valor de tipo uint32_t = 32bits
     */
    uint32_t,

    /**
     * Valor de tipo uint64_t = 64bits
     */
    uint64_t,
